...
def plot_trajectory(plotter: Plotter):
    ...
    #plot2D_drone_path(plotter, trajectory, waypoints, durations, drone_path, Derivative.SNAP, "OIAC")
    plot_drone_force_and_torque(plotter, waypoints, durations, drone_force_and_torque, Derivative.SNAP, "OIAC")
