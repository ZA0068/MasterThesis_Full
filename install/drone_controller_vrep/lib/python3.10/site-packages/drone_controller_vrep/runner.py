...
class Runner():
    def __init__(self):
        ...
        self.__optimal_trajectory_gaussians = {}
        self.__drone_trajectory = {}
        self.__drone_trajectory_gaussians = {}
        self.__drone_force_and_torque = {}
        self.__drone_force_and_torque_gaussians = {}
        self.__drone_kd_values = [{}, {}]
        self.__drone_kd_values_gaussians = [{}, {}]
        self.__drone_error_data = {}
        self.__drone_error_data_gaussians = {}
    ...
    def __acquire_data(self):
        ...
        for diff in range(2):
            ...
            for gaussians in [0, 25, 50]:
                self.___acquire_data_gaussians_1(derivative, gaussians)
            for con in range(2):
                ...
                for gaussians in [25, 50]:
                    self.___acquire_data_gaussians_2(derivative, controller, gaussians)
    
    def ___acquire_data_gaussians_2(self, derivative, controller, gaussians):
        self.__drone_trajectory_gaussians[(derivative, controller, gaussians)] = read_data(f"drone_path_{derivative}_{controller}_{gaussians}_gaussian.csv")
        self.__drone_force_and_torque_gaussians[(derivative, controller, gaussians)] = read_data(f"drone_force_and_torque_{derivative}_{controller}_{gaussians}_gaussian.csv")
        self.__drone_error_data_gaussians[(derivative, controller, gaussians)] = read_data(f"drone_error_{derivative}_{controller}_{gaussians}_gaussian.csv")
        
    def ___acquire_data_gaussians_1(self, derivative, gaussians):
        append = f"_{gaussians}_gaussian" if gaussians != 0 else ""
        self.__optimal_trajectory_gaussians[(derivative, gaussians)] = read_data(f"rrt_trajectory_{derivative}{append}.csv")
        self.__drone_kd_values_gaussians[0][(derivative, gaussians)] = read_data(f"drone_K_values_{derivative}{append}.csv")
        self.__drone_kd_values_gaussians[1][(derivative, gaussians)] = read_data(f"drone_D_values_{derivative}{append}.csv")
